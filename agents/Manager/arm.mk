...
AGENTLIB = ../libs/*.o
OBJ = agent.o ProgramEngine.o TimedRuleEngine.o eventcounter.o ruleset.o timedruleset.o RuleEngine.o ActionEngine.o actionset.o action.o eventcounterset.o rule.o timedrule.o
BIN = ../bin
XML = ../tinyxml/*.o
