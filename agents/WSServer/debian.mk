...
AGENTLIB = ../minilibs/*.o
OBJ = agent.o AgentInterface.o NameTable.o RpcServer.o RpcRoutingMap.o TransTab.o Receiver.o ArchiveThread.o PushThread.o PushConnection.o RemoteServerThread.o JParser.o DeviceManager.o AlarmManager.o AlarmManagerSandA.o AlarmManagerTranslator.o AlarmManagerQueues.o AlarmManagerZones.o AlarmManagersrv.o AuthManager.o AuthManagerInit.o AuthManagerGet.o User.o AuthManagersrv.o AuthManagerUsersrv.o AutomatismManager.o AutomatismManagersrv.o LogManager.o UserLog.o Translator.o PwrManager.o PwrManagersrv.o SrvManager.o ConfManager.o GuiLib.o
BIN = ../bin
XML = ../tinyxml/*.o
